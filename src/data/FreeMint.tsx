export const textFreeMintRules = [
  ...
  "3. Ensure you have selected the BNB test network (for instructions on switching to BNB test, please refer to : https://medium.com/@gezimosmanii/a-simple-guide-to-adding-goerli-testnet-to-your-metamask-wallet-2023-step-by-step-guide-ce34b70e3125).",
